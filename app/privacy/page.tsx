...
export default function Privacy() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-10 prose prose-stone">
      ...
      <p>
        We do not collect any personal information directly. When you visit our
      ...
      <h2>Cookies</h2>
      <p>
        Our advertising partners may place cookies on your device to track
        browsing behavior for ad targeting purposes. You can control cookie
        settings through your browser. Disabling cookies may affect how ads are
        displayed but will not affect your ability to use this site.
      </p>

      <h2>Third-Party Links</h2>
      <p>
        Some ads and links on this site may direct you to third-party websites.
