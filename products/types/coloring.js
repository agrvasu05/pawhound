...
async function generate(outRoot) {
  ...
  const c = await lib.chatJSON({
    system: 'You create printable COLORING PAGE packs that sell on Pinterest/Etsy (dog lovers, parents). US English.',
    user: `Theme: ${theme}. Plan a ${PAGE_COUNT}-page coloring book. Give the listing, Pinterest copy, and ${PAGE_COUNT} distinct page subjects.`,
    schema: SCHEMA,
  });
  ...
  return {
    ...
    board: { name: 'Pet Coloring Pages (Printable)', description: 'Printable pet & dog coloring pages for kids and adults — instant digital downloads.' },
